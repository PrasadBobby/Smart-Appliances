...
.classic_button_next{ position: absolute; right: 80px; top: 500px; }
.classic_button_prev { position: absolute; left: 90px; top: 500px; }
.lawn{ position: absolute; left:600px; top: 250px; }
...
<img src="homemap.jpg" usemap="#image-map">
...
<!--
<map name="image-map">
    <area target="" alt="bedroom" title="bedroom" href="" id="bed" coords="126,550,389,158" shape="rect" onclick='console.log("bed")'>
  
   

	
    <area target="" alt="hall" title="hall" id="hall" coords="889,152,1177,594" nohref shape="rect" onClick="image-map.submit()" alt="Submit request">
	
    <area target="" alt="lawn" title="lawn" href="" id="lawn" coords="434,149,852,216" shape="rect" onclick='console.log("lawn")'>
</map>
-->
<!--
